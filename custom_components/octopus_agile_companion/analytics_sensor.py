"""Analytics sensor platform for Octopus Agile Companion."""
...
async def async_setup_entry(hass, entry, async_add_entities):
    """Set up Octopus Agile analytics sensors from a config entry."""
...
class OctopusAnalyticsBaseSensor(CoordinatorEntity, SensorEntity):
    """Base class for Octopus Agile analytics sensors."""
...
class EstimatedDailyCostSensor(OctopusAnalyticsBaseSensor):
...
class PotentialDailySavingsSensor(OctopusAnalyticsBaseSensor):
...
class EffectiveRateSensor(OctopusAnalyticsBaseSensor):
...
class UsageOptimizationScoreSensor(OctopusAnalyticsBaseSensor):
...
class BestTimeForLoadSensor(OctopusAnalyticsBaseSensor):
...
class BestChargeWindowSensor(OctopusAnalyticsBaseSensor):
...
class ExportArbitrageSensor(OctopusAnalyticsBaseSensor):
